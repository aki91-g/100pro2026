...
const messages = {
  en: {
    ...
    drawerDelete: 'Delete',
    drawerNoMotivationValue: 'No motivation provided',
    unarchive: 'Unarchive',
    restore: 'Restore',
    drawerNoTasksInTab: 'No tasks in this tab.',
  ...
  ja: {
    ...
    drawerArchive: 'アーカイブ',
    drawerDelete: '削除',
    drawerNoMotivationValue: 'モチベーション未設定',
    unarchive: 'アーカイブ解除',
    restore: '復元',
    drawerNoTasksInTab: 'このタブにはタスクがありません。',
